...
class DiggingDeeperController extends Controller
{
    ...
    /**
     * Базова інформація
     * @url https://laravel.com/docs/7.x/collections#introduction
     *
     * Довідкова інформація
     * @url https://laravel.com/api/7.x/Illuminate/Support/Collection.html
     *
     * Варіант колеції для моделі eloquent
     * @url https://laravel.com/api/7.x/Illuminate/Database/Eloquent/Collection.html
     *
     */
...
*/
       ...
       // dd(compact('filtered')); //закоментувати 91-106 рядки перед перевіркою
        $sortedSimpleCollection0 = collect([5, 3, 1, 2, 4]);
        $sortedSimpleCollection = collect([5, 3, 1, 2, 4])->sort()->values();
        $sortedAscCollection = $collection->sortBy('created_at');
        $sortedDescCollection = $collection->sortByDesc('item_id');

        //dd(compact('sortedSimpleCollection0','sortedSimpleCollection', 'sortedAscCollection', 'sortedDescCollection'));
